	...
	class avia_sc_heading extends aviaShortcodeTemplate{
			...
			function shortcode_handler($atts, $content = "", $shortcodename = "", $meta = "")
			{
        		...
        		if($heading)
        		{
	        		...
	        		$output .= "<div {$styling} class='av-special-heading av-special-heading-{$tag} {$color} {$style} {$class}'><{$tag}>{$heading}</{$tag}><div class='special-heading-border'><div class='special-heading-inner-border'></div></div></div>";
        		}
