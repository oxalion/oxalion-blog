...
if(!function_exists('avia_backend_auto_updater'))
{
	...
	class avia_auto_updates{
		...
		{
			if($info->get('Name') == $this->themename)
			{
		...
		public static function option_page_data($avia_elements)
		{
			$avia_elements[] = array(	"name" => "Update your Theme from the WordPress Dashboard",
								"desc" => "If you want to get update notifications for your themes and if you want to be able to update your theme from your WordPress backend you need to enter your Themeforest account name as well as your Themeforest Secret API Key bellow:",
								"std" => "",
								"slug"	=> "update",
								"type" => "heading",
								"nodescription"=>true);
		...
		public static function backend_html()
		{
			...
			else if($update = self::check_for_theme_update())
			{
				...
				$output .= "A new Version (".$new.") of your Theme is available! You are using Version ".$version.". <br/>Do you want to update?<br/><br/>";
				//$output .= "";
